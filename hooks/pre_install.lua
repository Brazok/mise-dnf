...
function PLUGIN:PreInstall(ctx)
    ...
    local tool_name = ctx.name

    -- Example 1: Simple binary download
    -- local url = "https://github.com/<GITHUB_USER>/<GITHUB_REPO>/releases/download/v" .. version .. "/mise-dnf-linux-amd64"

    -- Example 2: Platform-specific binary
    local platform = get_platform() -- Uncomment the helper function below
    local url = "https://github.com/" .. author .. "/" .. tool_name ..  "/releases/download/v" .. version .. "/" .. tool_name .. "-" .. platform .. ".tar.gz"

    -- Example 3: Archive (tar.gz, zip) - mise will extract automatically
    -- local url = "https://github.com/<GITHUB_USER>/<GITHUB_REPO>/releases/download/v" .. version .. "/mise-dnf-" .. version .. "-linux-amd64.tar.gz"

    -- Example 4: Raw file from repository
    -- local url = "https://raw.githubusercontent.com/<GITHUB_USER>/<GITHUB_REPO>/" .. version .. "/bin/mise-dnf"

    -- Replace with your actual download URL pattern
    -- local url = "https://example.com/mise-dnf/releases/download/" .. version .. "/mise-dnf"
    ...
    return {
        ...
        note = "Downloading " .. tool_name .. "@" .. version,
